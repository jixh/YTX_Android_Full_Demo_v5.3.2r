...
//        @Override
//        public void onProvidePreviewCameraData(byte[] data, int width, int height, int rotation) {
//
//        }

//        @Override //selftest
//        public void onReceiveThreePartConfNotify(String member, int var) {
//
//
//            if(getInstance().mOnCallEventNotifyListener!=null){
//                getInstance().mOnCallEventNotifyListener.onReceiveThreePartConfNotify(member, var);
//            }
//
//
//        }
//
//        @Override
//        public void onPauseCall(String callId, int type) {//selftest
//
//        }
//
//        @Override
//        public void onResumeCall(String callId, int type) {
//
//        }
