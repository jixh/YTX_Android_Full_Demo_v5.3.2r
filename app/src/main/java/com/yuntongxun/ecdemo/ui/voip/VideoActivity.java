...
//         mDiaerpadBtn.setVisibility(View.VISIBLE);
        ...
        zhuanjie.setVisibility(View.GONE);
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.camera_invite:
                  ECVoIPSetupManager manager =  SDKCoreHelper.getVoIPSetManager();
                  if(manager==null){
                      return;
                  }
                  String text = ((TextView)invite).getText().toString().trim();

                  if("美颜".equalsIgnoreCase(text)){
                      manager.setBeautyFilter(true);
                      ((TextView) invite).setText("取消美颜");
                  }else {
                      manager.setBeautyFilter(false);
                      ((TextView) invite).setText("美颜");
                  }
            ...
            case R.id.kill_voip:
                ...
                ECDevice.getECVoIPSetupManager().setMagicSound(mCallId,true,10,0);
                break;
