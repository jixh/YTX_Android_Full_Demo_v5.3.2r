...
public class ECNotificationManager {
    ...
    public final void showKickoffNotification(Context context , String kickofftext) {
        ...
        Notification notification = showNotification(context,"",R.drawable.ic_launcher,kickofftext,pendingIntent);
...
//        notification.setLatestEventInfo(context, kickofftext, "", pendingIntent);
    ...
    private static Notification showNotification(Context mContext,String mContentTitle,int icon,String contentText,PendingIntent mContentIntent){
        Notification mNotification = null;
        if (Build.VERSION.SDK_INT <16) {
            mNotification = new Notification(icon, null, System.currentTimeMillis());
    ...
    public static void showCallingNotification(ECVoIPCallManager.CallType callType) {
        try {
            ...
            Notification notification = showNotification(getInstance().mContext,"",R.drawable.title_bar_logo,topic,contentIntent);
